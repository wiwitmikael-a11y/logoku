    ...
    return (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="relative bg-surface rounded-2xl shadow-xl p-8 max-w-sm w-full text-center">
                <h2 className="text-2xl font-bold text-accent mb-2">Waduh, Spark Habis!</h2>
                <p className="text-text-body mb-4">Spark ✨ gratis Anda untuk hari ini sudah habis. Spark akan di-reset kembali besok.</p>
