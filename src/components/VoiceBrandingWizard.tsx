    ...
    return (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="relative bg-surface rounded-2xl shadow-xl p-8 max-w-lg w-full">
                <h2 className="text-xl font-bold text-text-header">Voice Branding Wizard</h2>
                <p className="text-text-body mt-2">This feature is coming soon! Create a unique voice for your brand.</p>
