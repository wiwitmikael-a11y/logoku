...
const ProjectDashboard: React.FC<Props> = ({ onToggleTheme, theme }) => {
  ...
  const { toggleProfileModal, toggleVoiceWizard } = useUI();
    ...
    <div className="p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex justify-between items-center mb-6">
        ...
        <div className="flex items-center gap-2">
            <button onClick={() => toggleVoiceWizard(true)} className="p-2 rounded-full text-text-muted hover:bg-surface hover:text-primary transition-colors" title="Konsultasi Suara dengan Mang AI">
