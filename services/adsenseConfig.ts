...
export const AD_PUBLISHER_ID = import.meta.env.VITE_AD_PUBLISHER_ID || "ca-pub-6110736010099308";

// ID Slot untuk Smart Banner yang nempel di bawah (Anchor Ad)
export const AD_SLOT_ID_BANNER = import.meta.env.VITE_AD_SLOT_ID_BANNER || "5474214451";
...
export const AD_SLOT_ID_IN_CONTENT = import.meta.env.VITE_AD_SLOT_ID_IN_CONTENT || "3997085444";