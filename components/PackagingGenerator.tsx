...
const packagingConfigs: PackagingCategory = {
  'Makanan': [
    { id: 'paper_bowl', name: 'Paper Bowl / Rice Bowl', prompt: 'Take the provided logo image. Create a realistic, high-quality product mockup of a white paper bowl. The bowl is filled with an appetizing depiction of "{{businessDetail}}". Place the logo prominently and clearly on the side of the bowl. The brand is "{{businessName}}". The background is a clean, minimalist cafe setting. This is a commercial product photo, not a flat vector.' },
    { id: 'rice_box', name: 'Nasi Box Karton', prompt: 'Take the provided logo image. Create a realistic mockup of a folded cardboard takeaway box (nasi box) with the food "{{businessDetail}}" visible inside or next to it. The box is a natural brown kraft paper color. Place the logo large and centered on the top lid. The brand is "{{businessName}}". The mockup should look like a professional photo for a food delivery service like GoFood/GrabFood.' },
    { id: 'standing_pouch', name: 'Standing Pouch (Snack/Frozen Food)', prompt: 'Take the provided logo image. Create a realistic product mockup of a sealed plastic or foil standing pouch (kemasan pouch) designed for "{{businessDetail}}". The product itself should be visible through a clear window on the pouch or placed next to it. The pouch is on a clean, white surface. Place the logo prominently on the front. The brand is "{{businessName}}". The style is professional and ready for retail.' },
  ...
  'Minuman': [
    { id: 'plastic_cup', name: 'Gelas Plastik (Kopi/Boba)', prompt: 'Take the provided logo image. Create a realistic photo mockup of a transparent plastic cup with a lid, filled with a beverage representing "{{businessDetail}}". Place the logo clearly on the side of the cup. The brand is "{{businessName}}". The style is modern and trendy, suitable for a contemporary Indonesian coffee shop. Clean, bright background.' },
    { id: 'beverage_bottle', name: 'Botol Plastik (Jus/Kopi Literan)', prompt: 'Take the provided logo image. Create a realistic mockup of a 250ml or 1 liter plastic bottle filled with "{{businessDetail}}". The logo is on a sticker label on the bottle. The brand is "{{businessName}}". The style is clean and modern.' },
  ],
  'Fashion': [
