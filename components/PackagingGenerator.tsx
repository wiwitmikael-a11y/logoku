    ...
    <div className="flex flex-col gap-10">
      ...
      {designs.length > 0 && (
        <div ref={resultsRef} className="flex flex-col gap-6 items-center scroll-mt-24">
          <h3 className="text-3xl md:text-4xl font-bold text-center text-text-header">Hasil Foto Produk 3-in-1:</h3>
      ...
      {modalImageUrl && (<ImageModal imageUrl={modalImageUrl} altText={`Desain kemasan untuk ${projectData.brandInputs?.businessName}`} onClose={() => setModalImageUrl(null)} />)}
    </div>
  );
};
