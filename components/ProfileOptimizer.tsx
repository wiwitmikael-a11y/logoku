  ...
  return (
    <div className="flex flex-col gap-8 items-center">
      <div className="text-center">
        <h2 className="text-4xl md:text-5xl font-bold text-splash mb-2">Langkah 5: Optimasi Profil Sosmed & Marketplace</h2>
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card title="Bio Instagram" className="animate-item-appear">
              <div className="bg-background p-4 rounded-lg space-y-2 border border-border-main">
                <div className="flex items-center gap-3">
                    <img src={projectData.socialMediaKit?.profilePictureUrl} alt="logo" className="w-12 h-12 rounded-full bg-surface p-0.5 border" />
            ...
            <Card title="Bio TikTok" className="animate-item-appear" style={{animationDelay: '100ms'}}>
              <div className="bg-background p-4 rounded-lg text-center border border-border-main">
                <img src={projectData.socialMediaKit?.profilePictureUrl} alt="logo" className="w-16 h-16 rounded-full bg-surface p-1 mx-auto border" />
