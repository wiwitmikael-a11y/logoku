...
// This initializes state directly and uses an arrow function for the event handler
// to ensure 'this' is correctly bound, resolving issues where 'this.props' and
// 'this.setState' were not recognized.
