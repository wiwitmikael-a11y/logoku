...
// FIX: Extended React.Component<Props, State> to make ErrorBoundary a proper React class component. This resolves errors where `this.setState` and `this.props` were not found.
