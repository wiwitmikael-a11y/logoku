...
const SupabaseKeyErrorScreen = ({ error }: { error: string }) => {
    ...
    const secretErrorCode = "[ERROR: KABEL_SBLS_PUTUS]";
            ...
            <div className="bg-surface border border-border-main p-6 rounded-lg shadow-md w-full">
                ...
                <details className="mt-6 text-left text-sm text-text-muted">
                    ...
                    <div className="mt-3 p-4 bg-background rounded-md border border-border-main space-y-3">
                        ...
                        <p>Aplikasi ini tidak bisa menemukan kunci koneksi ke database Supabase. Kunci ini harus diatur sebagai "Environment Variables" di platform hosting (misalnya Vercel).</p>
                        ...
                        <ol className="list-decimal list-inside space-y-2">
                            ...
                            <li>Pastikan ada dua variabel berikut:</li>
                            ...
                            <li>Setelah disimpan, <strong className="text-text-header">Redeploy</strong> (deploy ulang) proyek Anda dengan <strong className="text-text-header">tanpa cache</strong> agar perubahan terbaca.</li>
                        </ol>
                         <p className="mt-2 text-xs"><strong>Detail Error Internal:</strong> {error}</p>
                    </div>
                </details>
            </div>
