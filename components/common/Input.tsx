  ...
  return (
    <div className={className}>
      ...
      <input
        ...
        onFocus={handleFocus}
        className="w-full px-4 py-2.5 text-text-body bg-background border-2 border-border-main rounded-lg focus:outline-none focus:ring-2 focus:ring-splash/50 focus:border-splash transition-colors"
      />
    </div>
  );
};
