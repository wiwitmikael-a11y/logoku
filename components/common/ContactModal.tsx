  ...
  return (
    ...
    >
      <div className="relative max-w-sm w-full bg-surface rounded-2xl shadow-xl p-8 text-center flex flex-col items-center">
        ...
        <h2 id="contact-modal-title" className="text-4xl font-bold text-primary mb-2" style={{ fontFamily: 'var(--font-display)' }}>Mari Terhubung</h2>
        <p className="text-text-body mb-6">Aplikasi ini dikembangkan oleh <span className="font-semibold text-text-header">Rangga P. H.</span>, selaku Founder & Chief Everything Officer. Jangan ragu untuk menghubungi saya untuk pertanyaan, kolaborasi, atau masukan.</p>
