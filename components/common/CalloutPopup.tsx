...
const CalloutPopup: React.FC<CalloutPopupProps> = ({ children, className }) => {
  return (
    <div
      className={`
        bg-indigo-600 text-white text-sm font-semibold px-4 py-2 rounded-lg shadow-lg z-10
        relative before:content-[''] before:absolute before:w-0 before:h-0
        before:border-x-8 before:border-x-transparent before:border-t-8 before:border-t-indigo-600
