...
const ProjectDashboard: React.FC<ProjectDashboardProps> = (props) => {
  ...
  const [activeTab, setActiveTab] = useState<'projects' | 'sotoshop' | 'tools' | 'forum' | 'juragan' | 'aipetlab'>('projects');
  ...
  const tabs = [
    ...
    { id: 'aipetlab', name: 'AIPet Lab', icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-indigo-400" viewBox="0 0 20 20" fill="currentColor"><path d="M10 3.5a1.5 1.5 0 013 0V4a1 1 0 001 1h3a1 1 0 011 1v3a1 1 0 01-1 1h-.5a1.5 1.5 0 000 3h.5a1 1 0 011 1v3a1 1 0 01-1 1h-3a1 1 0 00-1-1v-.5a1.5 1.5 0 01-3 0V15a1 1 0 00-1 1H6a1 1 0 01-1-1v-3a1 1 0 011-1h.5a1.5 1.5 0 000-3H6a1 1 0 01-1-1V6a1 1 0 011-1h3a1 1 0 001-1v-.5z" /></svg> },
  ];

  const handleTabClick = (id: string) => {
      if (id === 'sotoshop') props.onShowSotoshop();
      else if (id === 'aipetlab') props.onShowAIPetLab();
