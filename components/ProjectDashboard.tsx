            ...
            <div className="relative mt-12 flex flex-col items-center gap-4 w-full max-w-md">
                ...
                <div className="w-full text-center">
                    <Button
                        ...
                        size="large"
                        className="w-full p-[3px] bg-gradient-to-r from-fuchsia-600 to-sky-500 rounded-lg group animate-ai-fab-pulse !shadow-none"
                    >
                        <span className="w-full h-full bg-surface text-text-header group-hover:bg-transparent group-hover:text-white rounded-md flex items-center justify-center gap-3 transition-all duration-200">
                             <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z" /></svg>
                             Konsultasi Suara (5 Menit)
                        </span>
                    </Button>
                    <p className="text-xs text-text-muted px-4 mt-2">Ngobrol langsung sama Mang AI buat bikin fondasi brand.</p>
                </div>
            </div>
