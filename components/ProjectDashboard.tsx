...
const ProjectDashboard: React.FC<ProjectDashboardProps> = (props) => {
  ...
  const tabs = [
    ...
    { id: 'tools', name: 'Ide Cepat', icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-yellow-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" /></svg> },
    ...
    <div className="flex flex-col gap-8">
      <div className="text-center">
        ...
        <p className="text-text-muted max-w-3xl mx-auto">
            ...
            cari <strong className="text-yellow-400 font-semibold">Ide Cepat</strong>, 
      ...
      <div className="mt-4">
        ...
        {activeTab === 'lemari' && (<Suspense fallback={<div className="flex justify-center items-center min-h-[50vh]"><LoadingMessage /></div>}><LemariKreasi onShowSotoshop={() => toggleSotoshop(true)} /></Suspense>)}
