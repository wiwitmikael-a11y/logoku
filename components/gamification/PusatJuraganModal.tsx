...
import PusatJuragan from './PusatJuragan';
...
const PusatJuraganModal: React.FC<Props> = ({ show, onClose }) => {
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="pusat-juragan-modal-title"
      tabIndex={-1}
    >
      <div className="relative max-w-4xl w-full h-[90vh] bg-surface rounded-2xl shadow-xl flex flex-col">
        <header className="p-4 border-b border-border-main flex-shrink-0 flex justify-between items-center">
             <h2 id="pusat-juragan-modal-title" className="text-xl font-bold text-primary"> 🏆 Pusat Juragan </h2>
