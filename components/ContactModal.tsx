  ...
  return (
    ...
    >
      <div className="relative max-w-sm w-full bg-surface rounded-2xl shadow-xl p-8 text-center flex flex-col items-center">
        ...
        <h2 id="contact-modal-title" className="text-2xl font-bold text-primary mb-2">Sokin, Kenalan!</h2>
        ...
        <div className="flex flex-col gap-3 w-full">
            ...
            <a href="https://www.instagram.com/rangga.p.h" target="_blank" rel="noopener noreferrer" onClick={handleLinkClick} className="w-full flex items-center justify-center gap-3 bg-background hover:bg-border-main text-text-body font-semibold py-3 px-4 rounded-lg transition-colors">
