  ...
  return (
    <div className="flex flex-col gap-8 max-w-4xl mx-auto">
      <div className="text-center">
        <h2 className="text-4xl md:text-5xl font-bold text-splash mb-2">Generator Konten Instan</h2>
        <p className="text-text-muted max-w-3xl mx-auto">Ubah ide jadi 1 paket konten siap posting (1 gambar + 3 caption) dalam sekejap! Cukup kasih topik, dan Mang AI akan meracik semuanya sesuai brand "{projectData.selectedPersona?.nama_persona}" lo. (+75 XP)</p>
      </div>
      ...
      {generatedContent && (
        <div className="bg-orange-400/10 border border-orange-400/20 rounded-lg p-4 flex items-start gap-4 text-left">
            ...
            <div>
                ...
                <p className="text-sm text-orange-300/80 mt-1">Konten ini hanya sementara. Segera unduh gambar dan salin caption-nya. <strong>Konten akan hilang jika lo me-refresh atau meninggalkan halaman ini.</strong></p>
            </div>
        </div>
      )}
