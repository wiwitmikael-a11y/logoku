  ...
  return (
    <div className="flex flex-col gap-8 items-center">
      <div className="text-center">
        <h2 className="text-4xl md:text-5xl font-bold text-splash mb-2">Langkah 9: Teks Iklan Sosmed</h2>
                    ...
                    <div className="space-y-4">
                        <div className="bg-background p-4 rounded-lg border border-border-main">
                             <div className="flex items-center gap-3 mb-3">
                                <img src={projectData.socialMediaKit?.profilePictureUrl} alt="logo" className="w-10 h-10 rounded-full bg-surface p-0.5 border" />
                                <div>
