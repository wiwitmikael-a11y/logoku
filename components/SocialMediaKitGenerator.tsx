  ...
  return (
    <div className="flex flex-col gap-8 items-center">
      <div className="text-center">
        <h2 className="text-4xl md:text-5xl font-bold text-primary mb-2">Langkah 4: Social Media Kit</h2>
      ...
      {assets && (
        <div className="bg-accent/10 border border-accent/20 rounded-lg p-4 flex items-start gap-4 text-left w-full max-w-4xl">
            ...
            <div>
                ...
                <p className="text-sm text-accent/80 mt-1">Aset visual ini hanya disimpan sementara di browser. Segera lanjutkan ke langkah berikutnya untuk menyimpan progres. <strong>Progres akan hilang jika lo me-refresh atau menutup halaman ini.</strong></p>
            </div>
        </div>
      )}
      ...
      {assets && (
        <div ref={resultsRef} className="flex flex-col gap-8 items-center scroll-mt-24 w-full max-w-5xl">
            <h3 className="text-3xl md:text-4xl font-bold text-center text-text-header">Aset Visual Sosmed Lo:</h3>
