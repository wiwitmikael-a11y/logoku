  ...
  return (
    <div className="flex flex-col gap-8 items-center">
      <div className="text-center">
        <h2 className="text-xl md:text-2xl font-bold text-indigo-400 mb-2">Langkah 4: Social Media Kit</h2>
        <p className="text-gray-400 max-w-3xl">
          Tampilan profil itu penting! Di sini, Mang AI akan membuatkan foto profil dan banner header yang serasi untuk muka depan sosial media lo (Facebook, X, YouTube, dll.).
        </p>
      </div>
      ...
      {assets && (
        <div className="bg-yellow-900/40 border border-yellow-700/50 rounded-lg p-4 flex items-start gap-4 text-left w-full max-w-4xl">
