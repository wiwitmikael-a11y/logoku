    ...
    <>
      <div className="flex flex-col gap-6 items-center text-center">
        ...
        <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-left">
          ...
          {/* Column 1: Master Data & Text Assets */}
          <div className="flex flex-col gap-6">
            ...
            <Card title="Profil Sosmed & Marketplace">
          ...
          <div className="flex flex-col gap-6">
             <Card title="Kalender Konten Mingguan">
              ...
              <Card title="Branding Lanjutan & Tools">
