            ...
            <header className="py-3 px-4 md:py-4 md:px-8 bg-gray-900/80 backdrop-blur-sm sticky top-0 z-10 border-b border-gray-800">
                <div className="max-w-7xl mx-auto flex justify-between items-center relative">
                    ...
                    <div className="flex items-center gap-2 md:gap-4 relative">
                        ...
                        {/* Combined Token & User Menu */}
                        <div className="rgb-laser-wrapper rounded-full">
                            <div className="flex items-center bg-gray-800 rounded-full">
                                {/* Token Info Section */}
                                <div className="relative" ref={tokenInfoRef}>
                                    <div onClick={() => setIsTokenInfoOpen(p => !p)} className="flex items-center gap-2 px-3 py-1.5 h-full rounded-l-full text-yellow-400 cursor-pointer hover:bg-gray-700/50 transition-colors" title="Info token">
                                ...
                                {/* User Menu Section */}
                                <div className="relative pr-0.5" ref={userMenuRef}>
                                    <button
