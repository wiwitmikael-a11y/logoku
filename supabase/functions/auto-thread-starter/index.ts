...
console.log("Auto Thread Starter function initializing...");
  ...
  try {
    ...
    // Contoh penggunaan Gemini API di dalam fungsi
     const response = await ai.models.generateContent({
      ...
      contents: `Buat satu paragraf pembuka thread diskusi yang menarik tentang topik: "${topic}"`,
    });

    return new Response(
      JSON.stringify({ thread_starter: response.text }),
